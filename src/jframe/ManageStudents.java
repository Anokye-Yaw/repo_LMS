...
public class ManageStudents extends javax.swing.JFrame {
     ...
     */
     ...
     public boolean addStudnet(){
          
          boolean isAdded = false;
          int studentId = Integer.parseInt(txtstudent_id.getText());
          ...
          try{
             ...
             String sql = "INSERT INTO stuent_details(student_id,name,course,branch) VALUES (?,?,?,?)";
             pst = conn.prepareStatement(sql);
    ...
    private void initComponents() {
        ...
        cmbcourse.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "BSC", "MSC", "PHD" }));
        jPanel1.add(cmbcourse, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 390, 250, 30));

        cmbbranch.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "IT", "CS", "PLAIN", "ELECTRONICS" }));
        jPanel1.add(cmbbranch, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 310, 250, 30));
    ...
    private void tblstudentdetailsMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblstudentdetailsMouseClicked
        ...
        cmbcourse.setSelectedItem(model.getValueAt(rowNo, 2).toString());
